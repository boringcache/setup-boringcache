...
export interface AllChecksums {
  [version: string]: VersionChecksums;
}

export const CHECKSUMS: AllChecksums = {
  'v1.0.0': {
...
export function getChecksum(version: string, asset: string): string | undefined {
  return CHECKSUMS[version]?.[asset];
}

export function hasChecksums(version: string): boolean {
  return version in CHECKSUMS;
}
